...
weather_chain = MarkovChain(transition_matrix=transition_matrix,states=['0', '1'])
...
print('testlis',len(test_list))
print('ytest',len(ytest))
acc = np.abs(test_list - ytest)
acd = 1-(np.count_nonzero(acc)/len(ytest))
print("accuracy is ", acd)
precision, recall, fscore, support = score(test_list,ytest)
